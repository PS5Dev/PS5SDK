...
set(CMAKE_ASM_FLAGS "-ffreestanding -fno-builtin -nostdlib -static")
set(CMAKE_C_FLAGS "${CMAKE_ASM_FLAGS} -DPPR -DPS5 -DPS5_FW_VERSION=${V_FW} -D_POSIX_SOURCE -D_POSIX_C_SOURCE=200112 -D__BSD_VISIBLE=1 -D__XSI_VISIBLE=500")
...
set(CMAKE_EXE_LINKER_FLAGS "-fuse-ld=lld -static -Xlinker -T ${CMAKE_CURRENT_SOURCE_DIR}/linker.x -Wl,--build-id=none -Wl,-Ttext=0x920100000 -Wl,-Tdata=0x926100000")
