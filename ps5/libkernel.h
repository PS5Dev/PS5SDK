...
_Fn_(uint64_t   , sceKernelDlsym,                               int, const char*, void*);
...
_Fn_(int        , sceKernelSendNotificationRequest,             int, void*, size_t, int);
...
_Fn_(void       , sceKernelSetProcessName,                      const char*);
...
_Fn_(int        , utimes,                                       const char *, const struct timeval *);
_Fn_(uint64_t   , uuidgen,                                      void);
_Fn_(pid_t      , wait,                                         int*);
_Fn_(pid_t      , wait3,                                        int *, int, struct rusage *);
